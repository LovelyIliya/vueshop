<template>
    <div>
        ...
        <el-card>
            <!--头部警告区域-->
            <el-alert class="cat_opt" title="注意：只允许为第三级分类设置相关参数！" type="warning" :closable="false" show-icon>
            </el-alert>
            <!--选择商品分类区域-->
            <el-row>
                <el-col>
                    ...
                    <el-table :data="manyTableData" border stripe>
                        ...
                        <el-table-column type="expand">
                            ...
                            <template slot-scope="scope">
                                <el-tag class="el-tag" v-for="(item,i) in scope.row.attr_vals" :key="i" closable
    ...
    <el-button type="primary" @click="addParams">确 定</el-button>
        ...
        <!--修改参数的对话框-->
        <el-dialog :title=" '修改' + titleText" :visible.sync="editDialogVisible" width="30%" @close="editDialogClose">
            <!--添加参数表单-->
    ...
    export default {
        ...
        methods: {
            ...
            async getParamsData() {
                ...
                //把每个参数的属性都转换为数组，这样就可以让tag标签循环渲染
